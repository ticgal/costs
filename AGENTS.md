...
- `front/` — explain what lives here and when agents should edit it.
- `hook.php/` — explain what lives here and when agents should edit it.
- `inc/` — explain what lives here and when agents should edit it.
- `LICENSE/` — explain what lives here and when agents should edit it.
- `locales/` — explain what lives here and when agents should edit it.
- `README.md/` — explain what lives here and when agents should edit it.
- `report/` — explain what lives here and when agents should edit it.
